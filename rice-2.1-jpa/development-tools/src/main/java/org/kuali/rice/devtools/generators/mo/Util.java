...
//	public static final List<String> COMMON_ELEMENTS = Arrays.asList(VERSION_NUMBER_FIELD, OBJECT_ID_FIELD);
	public static final List<String> COMMON_ELEMENTS = Arrays.asList(); // tenure
	...
	public static final String KUALI_LICENSE ="/**\n"
			+ " * Copyright 2005-" + THIS_YEAR + " The Kuali Foundation\n"
			+ " *\n"
			+ " * Licensed under the Educational Community License, Version 2.0 (the \"License\");\n"
			+ " * you may not use this file except in compliance with the License.\n"
			+ " * You may obtain a copy of the License at\n"
	...
	public static String toVaraible(String clazzName) {
		return toLowerCaseFirstLetter(shortClassName(clazzName));
	}
	
	public static String toVaraible(Class clazz) {
		return toLowerCaseFirstLetter(shortClassName(clazz));
	}
...
//		return (is ? "is" : "get") + Util.toUpperCaseFirstLetter(fieldName);
		return "get" + Util.toUpperCaseFirstLetter(fieldName); // Student uses getIs
	}

	public static String generateIsGetterName(String fieldName, boolean is) {
		return (is ? "is" : "get") + Util.toUpperCaseFirstLetter(fieldName);
	}
	...
	public static String generateServiceJavadoc(String serviceName) {
		return "{@link "
				...
				+ "} Service Description and Assumptions.  This service\n"
				+ "supports the management of " + serviceName.substring(0, serviceName.lastIndexOf("Service"))
	...
	public static String shortClassName(String shortClassName) {
		...
		if (shortClassName.endsWith(">")) {
			shortClassName = shortClassName.substring(0, shortClassName.length() -1);
		}
		return shortClassName;
	}

	public static String shortClassName(Class classToShort) {
		return shortClassName(classToShort.getName());
//		String shortClassName = classToShort.getName();
//		if (shortClassName.indexOf(".") > -1) {
//			shortClassName = shortClassName.substring(shortClassName.lastIndexOf(".") + 1, shortClassName.length());
//		}
//		return shortClassName;
	...
	// Student
	public static String generateCreateJavadocStudent(String dtoClassName, String shortClassName, String lowerCaseClassName) {
		return "Creates a new {@link " + Util.shortClassName(dtoClassName) + "}.  The " + shortClassName + " Type and Meta\n"
				+ "information may not be set in the supplied data object.\n\n"
				+ "@param " + shortClassName + "Type the type of the " + shortClassName + " to create\n"
				+ "@param " + Util.shortClassName(dtoClassName) + " the data with which to create the " + shortClassName + "\n"
				+ "@param contextInfo information containing the principleId and locale\n"
				+ "information about the caller of service operation\n"
				+ "@return the new " + shortClassName + "\n"
				+ "@throws DataValidationErrorException supplied data is invalid\n"
				+ "@throws InvalidParameterException " + Util.shortClassName(dtoClassName) + " or contextInfo is not valid\n"
				+ "@throws MissingParameterException " + shortClassName + "Id, " + shortClassName + "Type, " + Util.shortClassName(dtoClassName) + ", or contextInfo is missing or null\n"
	...
	public static String generateReadJavadoc(String dtoClassName) {
		return "Retrieves a single" + Util.shortClassName(dtoClassName) + " from the repository based on the given id.\n\n"
	...
	public static String generateReadJavadocStudent(String dtoClassName) {
		String serviceInterface = Util.shortClassName(dtoClassName);
		serviceInterface = serviceInterface.substring(0, serviceInterface.indexOf("Info"));
		return "Retrieves a " +serviceInterface + " by " + serviceInterface + " id.\n\n"
				+ "@param " + Util.toLowerCaseFirstLetter(serviceInterface) + "Id the identifier of the " + serviceInterface + " to be retrieced.\n"
				+ "@param contextInfo information containing the principleId and locale\n"
				+ "information about the caller of service operation\n"
				+ "@return the {@link " + serviceInterface + "} requested.\n"
				+ "@throws DoesNotExistException " + serviceInterface + "Id is not found\n"
				+ "@throws InvalidParameterException " + Util.shortClassName(dtoClassName) + " or contextInfo is not valid\n"
				+ "@throws MissingParameterException " + serviceInterface + "Id or contextInfo is missing or null\n"
				+ "@throws OperationFailedException unable to complete request\n"
				+ "@throws PermissionDeniedException an authorization failure occurred";
	}

	public static String generateReadByNameJavadoc(String dtoClassName) {
		return "Retrieves a " + Util.shortClassName(dtoClassName) + " from the repository based on the given namespace and name.\n\n"
				+ "@param namespace of the " + Util.shortClassName(dtoClassName) + " to retrieve.\n"
				+ "@param name of the " + Util.shortClassName(dtoClassName) + " to retrieve.\n"
				+ "@return a {@link " + Util.shortClassName(dtoClassName) + "} identified by the given namespace and name.  \n"
				+ "A null reference is returned if an invalid or non-existent id is supplied.";
	}
	...
	public static String generateUpdateJavadocStudent(String dtoClassName, String shortClassName,
			String dtoLowerCaseClassName) {
		return "Updates an existing {@link " + Util.shortClassName(dtoClassName) + "}.  The id, Type, and\n"
				+ "Meta information may not be changed.\n\n"
				+ "@param " + shortClassName + "Id the identifier of the " + shortClassName + " to be updated\n"
				+ "@param " + Util.shortClassName(dtoClassName) + " the new data for the " + shortClassName + "\n"
				+ "@param contextInfo information containing the principleId and locale\n"
				+ "information about the caller of service operation\n"
				+ "@return the updated " + shortClassName + "\n"
				+ "@throws DataValidationErrorException supplied data is invalid\n"
				+ "@throws DoesNotExistException " + shortClassName + "Id is not found\n"
				+ "@throws InvalidParameterException " + Util.shortClassName(dtoClassName) + " or contextInfo is not valid\n"
				+ "@throws MissingParameterException " + shortClassName + "Id, " + shortClassName + "Type, " + Util.shortClassName(dtoClassName) + ", or contextInfo is missing or null\n"
				+ "@throws OperationFailedException unable to complete request\n"
				+ "@throws PermissionDeniedException an authorization failure occurred\n"
	...
	public static String generateDeleteJavadocStudent(String dtoClassName, String shortClassName) {
		return "Deletes an existing {@link " + shortClassName(dtoClassName) + "}.\n\n"
				+ "@param " + Util.toLowerCaseFirstLetter(shortClassName) + "Id to delete.\n"
				+ "@param contextInfo information containing the principleId and locale\n"
				+ "information about the caller of service operation\n"
				+ "@throws DoesNotExistException " + shortClassName + "Id is not found\n"
				+ "@throws InvalidParameterException " + Util.shortClassName(dtoClassName) + " or contextInfo is not valid\n"
				+ "@throws MissingParameterException " + shortClassName + "Id or contextInfo is missing or null\n"
				+ "@throws OperationFailedException unable to complete request\n"
				+ "@throws PermissionDeniedException an authorization failure occurred";
	}
