...
public class ${service_class}DataLoadingDecorator2 extends ${service_class}Decorator implements ${service_class} {

    public ${service_class}DataLoadingDecorator2() {
        init ();
    }
    ...
    protected void loadData (ContextInfo contextInfo) {
        this.createTerm ("2015FA", "2014-09-15", "2015-12-15", ${service_class}Constants.ATP_FALL_TYPE_KEY, contextInfo);
        this.createTerm ("2015WI", "2015-01-15", "2015-03-15", ${service_class}Constants.ATP_WINTER_TYPE_KEY, contextInfo);
        this.createTerm ("2015SP", "2015-03-16", "2015-06-15", ${service_class}Constants.ATP_SPRING_TYPE_KEY, contextInfo);
        this.createTerm ("2015SU", "2015-07-15", "2015-08-15", ${service_class}Constants.ATP_SUMMER_TYPE_KEY, contextInfo);
    }
